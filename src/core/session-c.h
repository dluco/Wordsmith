...
/* Per-project view state: which binder folders were open, and which document
 * was being edited. See session.hpp for where the file lives, and why a project
 * with nothing saved is never an error.
 *
